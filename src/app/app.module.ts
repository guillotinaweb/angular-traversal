...
@NgModule({
    declarations: [AppComponent, FileComponent, FolderComponent, FolderDetailsComponent],
    imports: [BrowserModule, FormsModule, HttpClientModule, TraversalModule, FileInfoModule],
    providers: [
